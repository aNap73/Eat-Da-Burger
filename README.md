...
Folks can come in find burgers others have posted and then "Devour" them. Once  a burger is "Devoured" that burger moves to the Burger Log on the right side, where it is commemorated forever in all it's eaten glory. (more like it's made up glory till I wipe it :D)
